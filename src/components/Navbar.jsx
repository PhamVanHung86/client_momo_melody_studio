...
//     { label: "Mail Club", path: "/mail-clup" },
...
//     <>
//       <div
//         className={`fixed top-0 left-0 right-0 z-50 backdrop-blur-md shadow-sm border-b border-[#FFD6E0] transition-colors duration-300 ${
//           isHome ? "bg-[#c9c9ea]" : "bg-pastel-yellow"
//         }`}
//       >
//         {/* TẦNG 1 */}
//         <div className="flex items-center justify-between px-4 sm:px-[5vw] md:px-[7vw] lg:px-[9vw] py-8">
//           {/* Trái: Search */}
//           <div className="w-1/4 flex justify-start">
//             <button
//               onClick={() => setSearchOpen(true)}
//               className="flex items-center gap-2 text-[#1E293B]/50 hover:text-[#FFB7C5] transition-colors group"
//             >
//               <img
//                 src={assets.search_icon}
//                 className="w-4 opacity-50 group-hover:opacity-100 transition-opacity"
//                 alt="Search"
//               />
...
//                 className="text-2xl md:text-3xl lg:text-4xl text-[#1E293B] tracking-wide font-normal lowercase cursor-pointer hover:text-[#FFB7C5] transition-colors select-none"
//               >
...
//             <div className="hidden lg:flex items-center gap-1 cursor-pointer text-xs text-[#1E293B]/50 hover:text-[#FFB7C5] transition-colors">
//               <span>VND đ</span>
...
//                 ) : (
//                   <img
//                     className="w-4 opacity-50 hover:opacity-100 transition-opacity"
...
//                 <div className="flex flex-col gap-2 w-40 py-3 px-5 bg-white text-[#1E293B] rounded-2xl shadow-lg border border-[#FFD6E0] text-xs">
//                   {user ? (
//                     <>
//                       <p className="font-medium text-[#FFB7C5] truncate">
//                         {user.name}
//                       </p>
...
//               />
//               {getCartCount() > 0 && (
//                 <span className="absolute -right-1.5 -bottom-1.5 w-4 h-4 text-center leading-4 bg-[#FFB7C5] text-white font-bold rounded-full text-[8px]">
//                   {getCartCount()}
//                 </span>
//               )}
//             </Link>
...
//               className="w-4 cursor-pointer sm:hidden opacity-50"
//               alt="Menu"
//             />
//           </div>
//         </div>
...
//         {/* Divider */}
//         <div className="mx-4 sm:mx-[5vw] md:mx-[7vw] lg:mx-[9vw] h-[1px] bg-gradient-to-r from-transparent via-[#FFB7C5]/40 to-transparent" />

//         {/* TẦNG 2: Nav links */}
//         <div className="hidden font-medium sm:flex justify-center items-center gap-8 px-4 py-2.5">
//           {navLinks.map((item) => (
//             <NavLink
//               key={item.path}
//               to={item.path}
//               className={({ isActive }) =>
//                 `relative text-sm tracking-widest transition-colors pb-1 ${
//                   isActive
//                     ? "text-white font-medium"
//                     : "text-[#1E293B] hover:text-[#8b98e3]"
//                 }`
//               }
//             >
//               {({ isActive }) => (
...
//                   {item.label}
//                   {isActive && (
//                     <span className="absolute bottom-0 left-0 right-0 h-[1.5px] bg-[#FFB7C5] rounded-full" />
//                   )}
//                 </>
//               )}
//             </NavLink>
...
//       {/* Spacer */}
//       <div className="h-[95px] sm:h-[105px]" />
...
//             <div className="bg-white rounded-3xl shadow-2xl border border-[#FFD6E0] overflow-hidden">
//               {/* Input */}
//               <div className="flex items-center gap-3 px-5 py-4 border-b border-[#FFD6E0]/50">
//                 <img
//                   src={assets.search_icon}
//                   className="w-4 opacity-40 flex-shrink-0"
//                   alt=""
//                 />
//                 <input
//                   ref={inputRef}
...
//                   className="flex-1 text-sm text-[#4A4A6A] outline-none placeholder:text-[#4A4A6A]/30"
//                 />
//                 {searchQuery && (
//                   <button
//                     onClick={() => setSearchQuery("")}
//                     className="text-[#4A4A6A]/30 hover:text-[#FFB7C5] transition-colors text-lg leading-none"
//                   >
//                     ×
//                   </button>
//                 )}
...
//                       className="flex items-center gap-3 px-5 py-3 hover:bg-[#FFF0F5] transition-colors text-left border-b border-[#FFD6E0]/30 last:border-0"
//                     >
//                       <img
//                         src={p.image[0]}
//                         alt={p.name}
//                         className="w-10 h-10 rounded-xl object-cover bg-[#FFF0F5] flex-shrink-0"
//                       />
//                       <div>
//                         <p className="text-sm text-[#4A4A6A]">{p.name}</p>
//                         <p className="text-xs text-[#FFB7C5] font-medium">
...
//                     className="px-5 py-3 text-xs text-[#FFB7C5] hover:bg-[#FFF0F5] transition-colors text-center font-medium"
//                   >
...
//       >
//         <div className="flex flex-col text-[#4A4A6A] min-w-[288px]">
//           <div
//             onClick={() => setVisible(false)}
//             className="flex items-center gap-4 px-6 py-5 cursor-pointer border-b border-[#FFD6E0]"
//           >
//             <img
//               src={assets.dropdown_icon}
//               className="h-3.5 rotate-180 opacity-40"
//               alt="Back"
//             />
//             <p
//               style={{ fontFamily: "'Dancing Script', cursive" }}
...
//               onClick={() => setVisible(false)}
//               className={({ isActive }) =>
//                 `py-4 pl-8 border-b border-[#FFD6E0]/40 text-sm transition-colors ${
//                   isActive
//                     ? "text-[#FFB7C5] bg-[#FFD6E0]/20 font-medium"
//                     : "text-[#4A4A6A]/70 hover:bg-[#FFD6E0]/20 hover:text-[#FFB7C5]"
//                 }`
//               }
//             >
//               {item.label}
...
const Navbar = () => {
  ...
  return (
    <>
      ...
      >
        {/* TẦNG 1 */}
        <div className="flex items-center justify-between px-4 sm:px-[5vw] md:px-[7vw] lg:px-[9vw] py-5">
          {/* Trái: Search */}
          <div className="w-1/4 flex justify-start">
            <button
              onClick={() => setSearchOpen(true)}
          ...
          <div className="w-2/4 flex justify-center">
            <Link to="/">
              <h1
                style={{ fontFamily: "'Dancing Script', cursive" }}
                className="text-3xl md:text-4xl lg:text-5xl text-[#4A4A6A] tracking-wide font-normal lowercase cursor-pointer hover:text-[#8B98E3] transition-colors select-none"
              >
                momo's melody studio
              </h1>
            </Link>
