...
const About = () => {
  return (
    <>
      <SEO
        title="Về chúng tôi"
        description="Câu chuyện đằng sau momo's melody studio — studio handmade nhỏ xinh với tất cả tình yêu thương."
        url="/about"
      />
          ...
          <div className="flex flex-col md:flex-row items-center gap-12 mb-20">
            ...
            <div className="w-full md:w-1/2 flex flex-col gap-5">
              ...
              <p className="text-sm text-[#4A4A6A]/70 leading-relaxed">
                ...
                tim yêu thích sáng tạo. Mỗi sản phẩm được làm thủ công tỉ mỉ,
                từng chiếc phone charm, keychain hay sticker đều mang theo một
                câu chuyện riêng.
              </p>
              <p className="text-sm text-[#4A4A6A]/70 leading-relaxed">
                Chúng mình tin rằng những món đồ nhỏ xinh có thể mang lại nụ
                cười và niềm vui trong cuộc sống hàng ngày. Đó là lý do tại sao
                mỗi sản phẩm đều được làm với tất cả tình yêu thương.
              </p>
            </div>
          </div>
